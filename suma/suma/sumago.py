...
#"Intruder:[{'lat': 40.0,'lon': -75.0, 'alt_pres_ft': 340.0,'alt_hae_ft': 340.0,'vel_ew': 1.4512e-15, 'vel_ns': -23.699,'nic': 7, 'nacp': 10,'nacv': 2,'vfom_m': 8.0, 'sil': 3, 'sda': 1, 'v2v_uid': 100, 'mode_s': 100}]
        try:
            ...
            print("curTick: {} self._sxuLastTick: ".format(curTick, self._sxuLastTick))
...
if __name__ == "__main__":
    ...
    if num_args != 3:
        print("Usage:\r\n")
        print("       sumago.py [Display Server IP] [Display Server Port]\r\n")
        print("\r\n")
        exit(0)
    ...
    DispSrvrIp = sys.argv[1]

    #DAADisplayServer_IP = '192.168.137.1'
    DAADisplayServer_IP = DispSrvrIp
    #DAADisplayServer_PORT = 52275
    DAADisplayServer_PORT = int(sys.argv[2])
