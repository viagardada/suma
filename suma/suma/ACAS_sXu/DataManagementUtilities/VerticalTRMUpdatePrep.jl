function VerticalTRMUpdatePrep(this::TRM, st_trm::TRMState, input::TRMInput, ground_int::TRMIntruderInput )
...
DetermineIntruderVerticalValidity(input, ground_int)
...
st_int_iter.idx_online_cost = GetIndexFromClassification( intruder.classification,
online_cost_classifications )
...
st_int[j].idx_online_cost = GetIndexFromClassification( intruder.classification,
online_cost_classifications )
