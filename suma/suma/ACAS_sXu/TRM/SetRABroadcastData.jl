function SetRABroadcastData( vertical_ra_data::VTRMRAData, idx_tid::Z,
...
broadcast_msg.rat = vertical_ra_data.ra_term # Indicates the vertical RA has terminated andwill be used in blending
broadcast_msg.ldi = LDI_NONE
