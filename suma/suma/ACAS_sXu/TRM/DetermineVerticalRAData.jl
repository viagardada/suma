function DetermineVerticalRAData( st_own::TRMOwnState, display::DisplayLogic, multithreat::Bool,
single_sense::Bool, received_vrcs::Vector{Bool} )
# Deviation potential: Refer to ACAS sXu MOPS Vol. I section 1
vert_ra_data::VTRMRAData = VTRMRAData()
...
st_own.ra_output_prev.vert_ra_data = VTRMRAData()
else
