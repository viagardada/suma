function ConvertOwnInputsToEnuBeliefsGroundAndCompassMix( ground_speed::R, heading::R,
...
enu_belief.enu.vel_enu = [ horiz_speed_mps * sin(heading),
horiz_speed_mps * cos(heading),
b_vert.dz / m2ft ]
