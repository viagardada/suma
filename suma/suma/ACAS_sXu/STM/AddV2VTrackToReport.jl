function AddV2VTrackToReport(this::STM, report::StmReport, id::UInt32, T::R, passive_only::Bool)
...
(mu_vert, Sigma_vert) = PredictVerticalTracker(this, trk.mu_vert, trk.Sigma_vert, dt_vert, trk.alt_src_hae,false, is_large)
...
(trk_temp.mu_hor, trk_temp.Sigma_hor) = PredictPassiveTracker(this, trk_temp.mu_hor, trk_temp.Sigma_hor,dt_hor, true)
ReCenterHorizontalTrackLocation(trk_temp, T)
end
AddHorBias(this, trk_temp)
