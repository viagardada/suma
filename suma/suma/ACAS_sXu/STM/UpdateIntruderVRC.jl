function UpdateIntruderVRC(this::STM, intruders::Vector{TRMIntruderInput})
...
intruder.vrc = this.target_db[id].coord_data.vrc
end
end
end
end
received_vrcs::Vector{Bool} = copy( this.own.received_vrcs )
