...
#
TRMOwnInput( h::R, psi::R, track_angle::R, v2v_uid::UInt128, v2v_uid_valid::Bool,
...
ground_speed, airspeed, effective_turn_rate, effective_vert_rate )
TRMOwnInput() =
...
OwnVerticalBelief[], NaN, NaN, NaN, NaN )
end
