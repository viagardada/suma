function OnlineUncoordinatedActionCostEstimationDeviation( this::TRM, mode_int::Z, dz_min::R, dz_max::R, h_own::R,
...
update::Bool, s_c::OnlineCostStateDeviation, is_point_obs::Bool,
...
cost_ra = inc_cost
if ( !is_point_obs )
# Deviation Change for Inhibits: AltitudeInhibitCost
inc_cost = AltitudeInhibitCost( this, mode_int, dz_min, dz_max, dz_min_prev, dz_max_prev,
s_c.alt_inhibit )
...
idx_online_cost )
cost_ra = cost_ra + inc_cost
inc_cost = SafeCrossingRADeferralCost( save, mode_int, dz_min, dz_max, equip_int, z_own_ave, z_int_ave,
...
cost_ra = cost_ra + inc_cost
inc_cost = PointObsPreventEarlyCOCCost( this, mode_int, dz_min, dz_max, dz_min_int_prev,
dz_max_int_prev, z_own_ave, z_int_ave,
dz_own_ave, dz_int_ave, tau_expected )
cost_ra = cost_ra + inc_cost
end
return (cost_ra::R)
end
