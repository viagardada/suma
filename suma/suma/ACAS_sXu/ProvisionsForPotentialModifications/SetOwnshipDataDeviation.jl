function SetOwnshipDataDeviation(this::STM, report::StmReport, t::R)
...
SetOwnshipDegradedFlags(report, valid_alt_pres, valid_alt_hae)
if valid_alt_pres
...
report.trm_input.own.h_lo_ft = this.own.h_lo_ft
report.trm_input.own.h_hi_ft = this.own.h_hi_ft
